...
<template>
    ...
    >
        ...
        <section
            id="content-card"
            :class="[
                'col-span-full lg:col-span-6 2xl:col-span-4 grow order-1 lg:order-2 bg-primary-900 dark:bg-primary-dark-900 sm:shadow-xl sm:rounded-2xl w-full h-fit sm:ring-1 ring-gray-900/5',
