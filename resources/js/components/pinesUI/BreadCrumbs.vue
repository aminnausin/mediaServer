        ...
        >
            <template v-for="(breadCrumb, index) in breadCrumbs" :key="index">
                <li class="flex items-center h-full">
                    <RouterLink
                        :to="breadCrumb.url"
                        class="transition-colors inline-flex items-center p-2 py-1.5 space-x-1.5 rounded-md hover:text-neutral-900! dark:hover:text-white! hover:ring-[0.125rem] ring-inset hover:ring-violet-400 hover:bg-white dark:hover:ring-violet-700 dark:hover:bg-primary-dark-800"
