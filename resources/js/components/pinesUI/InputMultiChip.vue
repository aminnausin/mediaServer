    ...
    <div class="relative">
        <button
            ...
            :class="[
                ...
                `${select.selectOpen ? 'hocus:ring-0' : 'hocus:ring-[0.125rem]'} hover:ring-violet-400 dark:hover:ring-violet-700 focus:ring-indigo-400 dark:focus:ring-indigo-500 focus:outline-hidden`,
            ]"
            :disabled="disabled"
            type="button"
