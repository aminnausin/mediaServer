...
<template>
    <span
        class="flex text-left rounded-xl dark:bg-primary-dark-800/50 bg-primary-800 ring-1 ring-gray-900/5 dark:text-white shadow w-full divide-gray-300 dark:divide-neutral-400"
    >
        <div class="flex flex-col gap-2 ring-1 ring-inset ring-purple-700 rounded-xl shadow-sm w-full">
            <section
            ...
            >
                <div class="relative group flex flex-col gap-2 sm:gap-1 flex-1">
                    ...
                    <div class="flex gap-x-8 gap-y-2 flex-wrap">
                        ...
                        <span class="flex gap-x-4 flex-1 flex-wrap">
                            <h4
                ...
                <div class="px-2 text-xs flex flex-col gap-1 h-fit min-w-32">
        ...
        <ProiconsArrowReply class="-scale-y-100 h-6 w-6 mx-2 my-auto" />
    </span>
</template>
