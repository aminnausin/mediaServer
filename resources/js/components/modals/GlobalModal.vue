...
<template>
    <Teleport to="body">
        ...
        >
            ...
            >
                <div v-if="modalStore.isOpen" class="bg-opacity-70 absolute inset-0 h-full w-full backdrop-blur-xs"></div>
            </Transition>
            <Transition
                enter-active-class="ease-out duration-300"
            ...
            >
                <UseFocusTrap v-if="modalStore.isOpen" class="scrollbar-hide relative flex h-full max-h-screen w-full items-center overflow-y-scroll px-6 py-10 sm:py-6">
                    <OnClickOutside
