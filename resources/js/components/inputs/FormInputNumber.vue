    ...
    <span class="inline-flex relative w-full mt-1">
        ...
        <span class="absolute top-0 right-0 h-full flex flex-col w-12">
            <button
                ...
                class="h-1/2 items-center justify-center flex hover:bg-neutral-200/50 dark:hover:bg-neutral-600 rounded-tr-md ring-inset focus:outline-hidden focus:ring-[0.125rem] focus:ring-indigo-400 dark:focus:ring-indigo-500"
            ...
            <button
                ...
                class="h-1/2 items-center justify-center flex hover:bg-neutral-200/50 dark:hover:bg-neutral-600 rounded-br-md ring-inset focus:outline-hidden focus:ring-[0.125rem] focus:ring-indigo-400 dark:focus:ring-indigo-500"
