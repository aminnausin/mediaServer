...
<template>
    <nav id="navbar">
        <div class="flex p-1 gap-y-4 gap-2 flex-wrap sm:flex-nowrap justify-between">
            ...
            <span
                class="flex flex-wrap sm:flex-nowrap sm:max-w-sm items-center gap-1 sm:shrink-0 justify-end sm:justify-normal w-full sm:w-auto"
            >
                <section id="navbar-video" class="flex items-center gap-1 text-slate-900 antialiased">
                    ...
                    <NavLink
                        v-if="$route.name === 'history' || $route.name === 'settings' || $route.name === 'profile'"
                        :label="'home'"
                        :URL="'/'"
                    >
                        <template #icon>
