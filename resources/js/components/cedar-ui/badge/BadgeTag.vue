...
<template>
    <component
        ...
        :class="
            cn(
                'text-foreground-4 bg-primary dark:bg-primary-dark shrink-0 rounded-xl p-1 px-2 text-sm leading-none lowercase transition-colors duration-(--duration-input)',
                {
