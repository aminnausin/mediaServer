...
<template>
    ...
    >
        <UseFocusTrap
            ...
            :class="[
                popoverClass,
                `${popoverPosition === 'bottom' ? `top-8 ${verticalOffset ? `sm:top-${verticalOffset}` : 'sm:top-12'}` : `${verticalOffset ? `bottom-${verticalOffset}` : `bottom-12`}`}`,
        ...
        >
            ...
            >
                ...
                >
                    <div
                        :class="`h-2.5 w-2.5 transform rounded-sm border-l border-neutral-700/10 bg-neutral-800/90 ${popoverPosition === 'bottom' ? 'origin-bottom-left rotate-45 border-t' : 'origin-top-left -rotate-45 border-b'} `"
                    ></div>
                </div>
                <slot name="content">
