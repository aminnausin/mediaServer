...
<template>
    <div class="relative group rounded-xl overflow-clip">
        ...
        <section
            class="absolute bottom-6 w-[94.95%] m-auto left-0 right-0 opacity-0 group-hover:opacity-100 transition-opacity duration-75"
        >
            <!-- group-hover:block -->
            <svg
                class="ytp-heat-map-svg fill-indigo-200/20"
                height="100%"
