...
const applyStyle = () => {
    ...
    style.textContent = [
        '.download-controls {margin-right: 20px !important; margin-top: -4px !important; align-items: start !important; height: 100% !important;}',
...
<template>
    <am-lyrics
        ...
        v-show="enabled"
        ref="am-lyrics"
        class="pointer-events-auto! h-fit min-w-0 text-base"
        :song-title="title"
        :song-artist="artist"
        :song-album="album"
