        ...
        <div class="flex p-1 gap-y-3 flex-wrap justify-between">
            ...
            <span class="flex flex-wrap sm:flex-nowrap sm:max-w-sm items-center gap-2  sm:shrink-0">
                ...
                <section id="navbar-video" class="flex items-center space-x-2">
                    ...
                    <button v-if="auth" id="btn-nav-settings" class=" hidden justify-center items-center shrink-0 h-8 w-8 rounded-lg shadow-lg bg-red-300 hover:bg-red-200" aria-label="settings">
                        <svg xmlns="https://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" height="24" width="24" class="fill-slate-900">
