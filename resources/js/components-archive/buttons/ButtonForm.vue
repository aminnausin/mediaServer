...
const variantClass = computed(() => {
    switch (props.variant) {
        case 'submit':
            return [
                'inline-flex items-center justify-center h-10 max-h-full px-4 py-2 font-medium text-white transition-colors border border-transparent rounded-md focus:outline-hidden',
        ...
        case 'reset':
            return [
                'inline-flex items-center justify-center h-10 max-h-full px-4 py-2 font-medium transition-colors border dark:border-neutral-600 rounded-md focus:outline-hidden',
