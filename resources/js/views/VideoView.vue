                    ...
                    <div
                        ...
                        <div id="mp4-details"
                            ...
                            <section class="flex gap-2">
                                <button
                                    class="p-2 bg-button-100 dark:bg-button-900 rounded-lg dark:ring-neutral-700 hover:ring-violet-700 hover:bg-violet-400/50 ring-[0.125rem] ring-inset">Edit
                                    Details</button>
                                <button
