                    ...
                    <div
                        ...
                        <div id="mp4-details"
                            ...
                            <section class="flex gap-2">
                                <button
                                    class="p-2 bg-button-100 dark:bg-button-900 rounded-lg ring-violet-500 hover:ring-violet-800 hover:bg-violet-400/50 ring-[0.125rem] ring-inset">Edit
                                    Details</button>
                                <button
                                    class="p-2 bg-button-100 dark:bg-button-900 rounded-lg hover:ring-violet-500 hover:bg-violet-400/50 hover:ring-[0.125rem] ring-inset">
