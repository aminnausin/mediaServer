<script setup>
    ...
    const {username, email, avatar, login, csrfToken} = storeToRefs(authStore);
            ...
            <form method="POST" action="http://app.test:8080/api/login">
                ...
                <div class="block mt-4">
                    <label for="remember_me" class="inline-flex items-center">
                        <input id="remember_me" type="checkbox" class="rounded dark:bg-gray-900 border-gray-300 dark:border-gray-700 text-indigo-600 shadow-sm focus:ring-indigo-500 dark:focus:ring-indigo-600 dark:focus:ring-offset-gray-800" name="remember_me">
