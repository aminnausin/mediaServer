...
<template>
    <LayoutAuth>
        <template #content>
            ...
            <div
                class=" w-full sm:max-w-md mt-6 px-6 py-4 bg-white dark:bg-neutral-800 sm:shadow-md overflow-hidden sm:rounded-lg">
                <!-- Session Status -->
                <form class="flex flex-col gap-2" @submit.prevent="handleLogin">
                    ...
                    <div class="block">
                        <label for="remember_me" class="inline-flex items-center">
                            <input v-model="form.fields.remember" id="remember_me" type="checkbox"
